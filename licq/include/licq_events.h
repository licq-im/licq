...
//! Indicates that we have logged off.  UserId is owner. Argument is 0.
...
enum SubSignals_UPDATExLIST
{
  ...
  LIST_OWNER_ADDED = 8,         /**< An owner was added to the list */
  LIST_OWNER_REMOVED = 9,       /**< An owner was removed from the list */
};
