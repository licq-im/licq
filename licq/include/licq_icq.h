...
const unsigned short ICQ_SNACxLIST_ADDxVISIBLExLIST= 0x0008; // client
const unsigned short ICQ_SNACxLIST_UPDxGROUP       = 0x0009; // client
const unsigned short ICQ_SNACxLIST_REMxVISIBLExLIST= 0x000A; // client
