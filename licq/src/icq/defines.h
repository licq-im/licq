...
const uint16_t BART_TYPExITUNES_LINK            = 0x0009;
...
const uint8_t PLUGIN_PICTURE[]        = { 0x80, 0x66, 0x28, 0x83, 0x80, 0x28,
                                          0xD3, 0x11, 0x8D, 0xBB, 0x00, 0x10,
                                          0x4B, 0x06, 0x46, 0x2E, 0x00, 0x00 };

const uint8_t PLUGIN_FILExSERVER[]    = { 0xF0, 0x2D, 0x12, 0xD9, 0x30, 0x91,
                                          0xD3, 0x11, 0x8D, 0xD7, 0x00, 0x10,
                                          0x4B, 0x06, 0x46, 0x2E, 0x04, 0x00 };

const uint8_t PLUGIN_FOLLOWxME[]      = { 0x90, 0x7C, 0x21, 0x2C, 0x91, 0x4D,
                                          0xD3, 0x11, 0xAD, 0xEB, 0x00, 0x04,
                                          0xAC, 0x96, 0xAA, 0xB2, 0x02, 0x00 };

const uint8_t PLUGIN_ICQxPHONE[]      = { 0x3F, 0xB6, 0x5E, 0x38, 0xA0, 0x30,
                                          0xD4, 0x11, 0xBD, 0x0F, 0x00, 0x06,
                                          0x29, 0xEE, 0x4D, 0xA1, 0x00, 0x00 };

//these are used to get plugin list
const uint8_t PLUGIN_QUERYxINFO[]     = { 0xF0, 0x02, 0xBF, 0x71, 0x43, 0x71,
                                          0xD3, 0x11, 0x8D, 0xD2, 0x00, 0x10,
                                          0x4B, 0x06, 0x46, 0x2E, 0x00, 0x00 };

const uint8_t PLUGIN_QUERYxSTATUS[]   = { 0x10, 0x18, 0x06, 0x70, 0x54, 0x71,
                                          0xD3, 0x11, 0x8D, 0xD2, 0x00, 0x10,
                                          0x4B, 0x06, 0x46, 0x2E, 0x00, 0x00 };

// these are sent in handshake packets
const uint8_t PLUGIN_INFOxMANAGER[]   = { 0xA0, 0xE9, 0x3F, 0x37, 0x4F, 0xE9,
                                          0xD3, 0x11, 0xBC, 0xD2, 0x00, 0x04,
                                          0xAC, 0x96, 0xDD, 0x96, 0x00, 0x00 };

const uint8_t PLUGIN_STATUSxMANAGER[] = { 0x10, 0xCF, 0x40, 0xD1, 0x4F, 0xE9,
                                          0xD3, 0x11, 0xBC, 0xD2, 0x00, 0x04,
                                          0xAC, 0x96, 0xDD, 0x96, 0x00, 0x00 };

const uint8_t PLUGIN_NORMAL[]         = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                          0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                          0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

//capabilities sent in messages and on login
const uint8_t ICQ_CAPABILITY_SRVxRELAY[] = { 0x09, 0x46, 0x13, 0x49, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_DIRECT[] = { 0x09, 0x46, 0x13, 0x44, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_UTF8[]   = { 0x09, 0x46, 0x13, 0x4E, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };
const char ICQ_CAPABILITY_UTF8_STR[]  = "{0946134E-4C7F-11D1-8222-444553540000}";

const uint8_t ICQ_CAPABILITY_RTFxMSGS[] = { 0x97, 0xB1, 0x27, 0x51, 0x24, 0x3C,
                                          0x43, 0x34, 0xAD, 0x22, 0xD6, 0xAB,
                                          0xF7, 0x3F, 0x14, 0x92 };

const uint8_t ICQ_CAPABILITY_TYPING[] = { 0x56, 0x3F, 0xC8, 0x09, 0x0B, 0x6F,
                                          0x41, 0xBD, 0x9F, 0x79, 0x42, 0x26,
                                          0x09, 0xDF, 0xA2, 0xF3 };

const uint8_t ICQ_CAPABILITY_AIMxINTER[] = { 0x09, 0x46, 0x13, 0x4D, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_ICHAT[]  = { 0x09, 0x46, 0x00, 0x00, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_XTRAZ[]  = { 0x1A, 0x09, 0x3C, 0x6C, 0xD7, 0xFD,
                                          0x4E, 0xC5, 0x9D, 0x51, 0xA6, 0x47,
                                          0x4E, 0x34, 0xF5, 0xA0 };

const uint8_t ICQ_CAPABILITY_BART[]   = { 0x09, 0x46, 0x13, 0x46, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_FILE[]   = { 0x09, 0x46, 0x13, 0x43, 0x4C, 0x7F,
                                          0x11, 0xD1, 0x82, 0x22, 0x44, 0x45,
                                          0x53, 0x54, 0x00, 0x00 };

const uint8_t ICQ_CAPABILITY_LICQxVER[] = { 'L',  'i',  'c',  'q',  ' ',  'c',
                                          'l',  'i',  'e',  'n',  't',  ' ',
                                          0x00, 0x00, 0x00, 0x00 };

// XtraAway
const int XTRA_AWAY_COUNT = 32;
const uint8_t XtraAwayCaps[XTRA_AWAY_COUNT][0x10] = 
{
