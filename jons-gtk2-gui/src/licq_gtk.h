...
extern gboolean chat_send(GtkWidget *, GdkEventKey *, struct chat_window *);
...
extern gboolean contact_list_click(GtkWidget *, GdkEventButton *, gpointer);
...
extern gboolean send_key_request(gpointer);
extern gboolean key_request_close_window(gpointer);
...
extern void refresh_clist(GtkWidget *, gint);
...
extern GtkWidget *status_bar_new(gint border_width);
...
extern GtkWidget *system_status_new(gint border_width);
...
extern void licq_tray_set_content(GObject *, GdkPixbuf *, int);
