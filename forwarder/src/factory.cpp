...
public:
  ...
  std::string name() const { return "Forwarder"; }
...
{
  return "Usage: licq [options] -p forwarder -- [-ed] [-l <status>]\n"
      " -e          : start enabled\n"
...
{
  static LicqForwarder::Factory factory;
  return &factory;
}
